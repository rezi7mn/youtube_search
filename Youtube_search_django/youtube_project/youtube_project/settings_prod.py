...
SECRET_KEY = 'django-insecure-%xp(4k39dc8pqmmlh7d7d+6o4i*31_*$#$_a$!1)s9%z!lk2h='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['rezi7mn.pythonanywhere.com']
...
MIDDLEWARE = [
    ...
    # XFrameOptionsMiddleware removed to allow YouTube iframe embedding
]
...
# YouTube Data API key is read from secret.json or environment variables.
